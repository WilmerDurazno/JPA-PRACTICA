...
<body style="background-color: #575757;">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class=col-xs-4>
				<div>
					<h2 style="color: white; font-size: 25px">Buscar Producto</h2>
				</div>
				<div style="height: 30px"></div>
				<form method="post"
					action="http://localhost:8080/JPA-PRACTICA/BuscarProducto?eid=<%=request.getParameter("eid")%>">
					<div class="form-group">
						<label style="color: white; font-size: 23px" for="nombre">Nombre
